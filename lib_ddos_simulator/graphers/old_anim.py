...
class Animater(Base_Grapher):
    ...
    def save_graph(self, anim):
        ...
        if self.save:
            ...
            anim.save(path, progress_callback=callback, dpi=self.dpi, bitrate=bitrate)
